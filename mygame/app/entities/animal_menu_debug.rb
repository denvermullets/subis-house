...
class AnimalMenuDebug
  def self.create(args:, modal:, &on_click)
    ...
    animal_menu.add_component(SpriteComponent, SpriteComponent.new(path: 'assets/bg-animal-list.png', x: 900, y: 340, w: 340, h: 340))
    ...
    btn = Button.create_button(path: 'assets/btn-pause.png', x: 920, y: 360, w: 160, h: 60, z: 101) do
