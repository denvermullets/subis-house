class ScrollableList
  ...
  def render_name(index)
    @args.outputs.labels << [@scroll_area_x + 10, calculate_y_position(index), @names[index], 255, 255, 255]
  end
  ...
  def render_scrollbar
    ...
    # @args.outputs.solids << [label_stack_x, scrollbar_position, 10, scrollbar_height, 192, 112, 195]
  end
